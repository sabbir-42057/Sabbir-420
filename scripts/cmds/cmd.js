...
module.exports = {
        ...
        langs: {
                vi: {
                        ...
                        loadedError: "❌ | 𝐋𝐨𝐚𝐝 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\" thất bại với lỗi\n%2: %3",
                        ...
                        unloadedError: "❌ | 𝐔𝐧𝐥𝐨𝐚𝐝 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\" thất bại với lỗi\n%2: %3",
                ...
                en: {
                        missingFileName: "⚠️ | 𝐏𝐥𝐞𝐚𝐬𝐞 𝐢𝐧𝐭𝐞𝐫 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐧𝐚𝐦𝐞 𝐲𝐨𝐮 𝐰𝐚𝐧𝐭 𝐭𝐨 𝐫𝐞𝐥𝐨𝐚𝐝 ",
                        loaded: ">🎀 \n𝐋𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\" 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲",
                        loadedError: "❌ | 𝐅𝐚𝐢𝐥𝐞𝐝 𝐭𝐨 𝐥𝐨𝐚𝐝 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\" 𝐰𝐢⁣𝐭𝐡 𝐞𝐫𝐫𝐨𝐫\n%2: %3",
                        loadedSuccess: "🥂 𝐋𝐨𝐚𝐝𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 (%1) 𝐜𝐨𝐦𝐦𝐚𝐧𝐝",
                        loadedFail: "😿< 𝐅𝐚𝐢𝐥𝐞𝐝 𝐭𝐨 𝐥𝐨𝐚𝐝 (%1) 𝐜𝐨𝐦𝐦𝐚𝐧𝐝\n%2",
                        openConsoleToSeeError: "🏷️ | 𝐎𝐩𝐞𝐧 𝐜𝐨𝐧𝐬𝐨𝐥𝐞 𝐭𝐨 𝐬𝐞𝐞 𝐞𝐫𝐫𝐨𝐫 𝐝𝐞𝐭𝐚𝐢𝐥𝐬",
                        missingCommandNameUnload: "⚠️ | 𝐏𝐥𝐞𝐚𝐬𝐞 𝐞𝐧𝐭𝐞𝐫 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐧𝐚𝐦𝐞 𝐲𝐨𝐮 𝐰𝐚𝐧𝐭 𝐭𝐨 𝐮𝐧𝐥𝐨𝐚𝐝",
                        unloaded: "✨ | 𝐔𝐧𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\" 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲",
                        unloadedError: "❌ | 𝐅𝐚𝐢𝐥𝐞𝐝 𝐭𝐨 𝐮𝐧𝐥𝐨𝐚𝐝 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 \"%1\" 𝐰𝐢𝐭𝐡 𝐞𝐫𝐫𝐨𝐫\n%2: %3",
                        missingUrlCodeOrFileName: "⚠️ | 𝐏𝐥𝐞𝐚𝐬𝐞 𝐞𝐧𝐭𝐞𝐫 𝐭𝐡𝐞 𝐮𝐫𝐥 𝐨𝐫 𝐜𝐨𝐝𝐞 𝐚𝐧𝐝 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐟𝐢𝐥𝐞 𝐧𝐚𝐦𝐞 𝐲𝐨𝐮 𝐰𝐚𝐧𝐭 𝐭𝐨 𝐢𝐧𝐬𝐭𝐚𝐥𝐥",
                        missingUrlOrConsole: "⚠️ | 𝐏𝐥𝐞𝐚𝐬𝐞 𝐞𝐧𝐭𝐞𝐫 𝐭𝐡𝐞 𝐮𝐫𝐥 𝐨𝐫 𝐜𝐨𝐝𝐞 𝐚𝐧𝐝 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐟𝐢𝐥𝐞 𝐧𝐚𝐦𝐞 𝐲𝐨𝐮 𝐰𝐚𝐧𝐭 𝐭𝐨 𝐢𝐧𝐬𝐭𝐚𝐥𝐥",
                        missingFileNameInstall: "⚠️ | 𝐏𝐥𝐞𝐚𝐬𝐞 𝐞𝐧𝐭𝐞𝐫 𝐭𝐡𝐞 𝐟𝐢𝐥𝐞 𝐧𝐚𝐦𝐞 𝐭𝐨 𝐬𝐚𝐯𝐞 𝐭𝐡𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 (with .js extension)",
                        invalidUrl: "⚠️ | 𝐏𝐥𝐞𝐚𝐬𝐞 𝐞𝐧𝐭𝐞𝐫 𝐚 𝐯𝐚𝐥𝐢𝐝 𝐮𝐫𝐥",
